    ...
    let ways = [
      {
        ...
        process: [
          {
            id: 1,
            title: "What are GLP-1 injections?",
...
`,
            description:
              "GLP-1 medication is a safe and clinically proven way to help you lose weight. This breakthrough medication acts on your metabolism to suppress your appetite, so you eat less food and lose more weight than with diet and exercise alone.&nbsp;",
          },
          {
            id: 2,
            title: "How do GLP-1 injections work?",
            icon: `<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
            description:
              "GLP-1s are naturally occurring hormones that send signals to your brain to control your appetite and metabolism. GLP-1 medications act on the same receptors in our brains as naturally occurring GLP-1s to improve metabolism and reduce appetite.",
          },
          {
            id: 3,
...
`,
            description:
              "When starting or when your dosage increases, you may experience short-term side effects while your body adjusts. Don’t worry, these tend to be mild—most commonly nausea, diarrhoea or vomiting—and usually go away within a couple of weeks.",
          },
          {
            id: 4,
...
`,
            description:
              "Using GLP-1 medication alongside Voy’s coaching, diet and exercise, you can expect to see results in 2-3 months. ",
          },
          {
            id: 5,
...
`,
            description:
              "We’re confident that you’ll lose at least 10% of your total body weight in 6 months—or your money back.",
          },
        ],
      },
    ];
